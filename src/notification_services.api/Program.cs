...
builder.Services.AddAuthentication(options =>
    ...
    {
        // A. Configura aqu� tu URL de Keycloak
        ...
        options.RequireHttpsMetadata = false; // Pon true en producci�n

        // B. Configuraci�n para validar el token
...
// Inyecci�n de Dependencias (Vincular Interfaces con Implementaciones)
